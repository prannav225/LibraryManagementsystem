            ...
            <div className="form" onSubmit={handleSubmit}>
                <form action="">
                    ...
                    <div className="shortdescription">
                        <textarea name="shortdescription" id="" cols="30" rows="10" value={shortDescription} onChange={(e) => setShortdescription(e.target.value)} required>

                        </textarea>
                    </div>
                    <div className="longdescription">
                        <textarea name="longdescription" id="" cols="30" rows="10" value={longDescription} onChange={(e) => setLongdescription(e.target.value)} required>
